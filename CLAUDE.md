...
The modal quotes **8 in 10** (the 81.3% across all respondents), never 88% — that figure belongs to the subgroup and lives in `#survey-modal`, which this modal links to. Older source text: `O que o SSP3-Forte pode fazer por Você.txt`.
