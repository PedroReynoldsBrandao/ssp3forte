...
'pt': dict(
    ...
    cap_resp='Intervalo de confiança a 95% para os 88,1%: 80,3 a 95,8.',
...
'br': dict(
    ...
    resp=[('Muito satisfeito', 22, '32,8', 32.8), ('Satisfeito', 37, '55,2', 55.2),
          ('Pouco satisfeito', 7, '10,4', 10.4), ('Nada satisfeito', 1, '1,5', 1.5)],
    resp_tot=('Satisfeitos ou muito satisfeitos', 59, '88,1', 88.1),
    cap_resp='Intervalo de confiança de 95% para os 88,1%: 80,3 a 95,8.',
...
'en': dict(
    ...
    cap_resp='95% confidence interval for the 88.1%: 80.3 to 95.8.',
